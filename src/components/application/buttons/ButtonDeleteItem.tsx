    ...
    return (
        <>
            <button
                ...
                className={`${
                    icon
                        ? "px-3 bg-red-600 text-white sm:hover:text-[var(--primary)] sm:text-[var(--dark)] sm:px-1 sm:bg-transparent dark:sm:text-[var(--darkModeText)] dark:sm:hover:text-[var(--darkModeTitle)]"
