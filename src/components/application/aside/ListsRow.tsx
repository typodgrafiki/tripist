    ...
    return (
        <>
            <li className="relative mb-3 sm:mb-1">
                <Link
                    href={thisUrl}
                    className={`bg-[#ECEEF2] dark:bg-[var(--darkModeLight)] dark:text-[#6D6F77] px-5 py-4 list-link animated block hover:bg-[#f4f4f5] sm:px-5 sm:py-3 sm:bg-transparent relative truncate dark:sm:bg-transparent ${
                        pathname === thisUrl
